...
import com.example.fooddeliveryapp.adapter.CustomerCartAdapter;
import com.example.fooddeliveryapp.model.CustomerCartModel;
...
public class CustomerCart extends AppCompatActivity {
    ...
    private void orderFood() {
        ...
        for (CustomerCartModel food : mList) {
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child(RegisterActivity.ORDER).child(food.getRestName()).child(firebaseUser.getUid());
