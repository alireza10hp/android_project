            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        reference = FirebaseDatabase.getInstance().getReference().child(RegisterActivity.CUSTOMER_USERS).child(userId);
                ...
                .requestLocationUpdates(locationRequest, new LocationCallback() {
                    ...
                    public void onLocationResult(@NonNull LocationResult locationResult) {
                        ...
                        if (locationResult != null && locationResult.getLocations().size() > 0) {
                            ...
                            DatabaseReference reference2 = FirebaseDatabase.getInstance().getReference().child(RegisterActivity.LOCATION_CUSTOMERS).child(username);
                            hashMap.put("id", userId);
                            hashMap.put("username", username);
                            ...
                            Toast.makeText(RegisterActivity.this, "latitude : " + latitude, Toast.LENGTH_SHORT).show();
                        }
                    }
