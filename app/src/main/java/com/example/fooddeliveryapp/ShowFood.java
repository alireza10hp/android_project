...
public class ShowFood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(ShowFood.this);
    ...
    private void setUi(String foodImage, String foodPrice, String foodDesc, String foodName) {
        ...
        Glide.with(ShowFood.this).load(foodImage).into(iv_foodImage);
    }
    ...
    private void addToCartFirebase() {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child(RegisterActivity.CART).child(userId);
        ...
        reference.push().setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()) {
                    Toast.makeText(ShowFood.this, "Foood Added To Cart Successfully " + userName, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ShowFood.this, "Food Adding Failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
